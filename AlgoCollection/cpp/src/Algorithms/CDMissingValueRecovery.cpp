...
#include "../../include/Algorithms/CDMissingValueRecovery.h"
...
// simplistic API
arma::mat CDMissingValueRecovery::RecoverMatrix(arma::mat &matrix, uint64_t k, double eps)
{
	// Copy state 
	arma::mat matrix_new = matrix;
	
    CDMissingValueRecovery rmv(matrix_new, 100, eps);
