#include <iostream>
#include "../../include/Algorithms/LinearImpute.h"

namespace Algorithms
{

arma::mat LinearImpute::LinearImpute_Recovery(arma::mat &input)
{
	// Copy state 
    ...
    {
        missing.emplace_back(arma::find_nonfinite(input_new.col(i)));
    }
    ...
    for (uint64_t i = 0; i < input_new.n_cols; ++i)
    {
        ...
        for (;;)
        {
            ...
            if (block_start > 0)
            {
                val1 = input_new.at(block_start - 1, i);
            }
            if (block_end < input_new.n_rows)
            {
                val2 = input_new.at(block_end + 1, i);
            }
            ...
            {
                input_new.at(block_start + j, i) = val1 + step * (double)(j + 1);
            }
        }
    }
