...
#include "../../include/Algorithms/IterativeSVD.h"
...
arma::mat IterativeSVD::recoveryIterativeSVD(arma::mat &X, uint64_t rank)
{
    ...
    while (iter < max_iters)
    {
        ...
        int code = Algebra::Algorithms::RSVD::rsvd(U, S, V, X_new, curr_rank);
        ...
        bool conv = converged(X_new, X_reconstructed, indices, threshold);
