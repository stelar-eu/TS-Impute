...
#include "../../include/Algorithms/PCA_MME.h"
...
arma::mat PCA_MME::doPCA_MME(arma::mat &matrix, uint64_t truncation, bool singleBlock){
	
	// Copy state 
	arma::mat matrix_new = matrix;
	
	PCA_MME pca(matrix_new, truncation, singleBlock);
